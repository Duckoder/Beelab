...
function Product() {
  ...
  const sortOptions = [
    ...
    { name: 'Yêu thích nhất', href: '#', current: false },
  ...
  const filters = [
    {
      ...
      name: 'Màu',
      options: [
        { value: 'Trắng', label: 'White', checked: false },
        { value: 'Beige', label: 'Beige', checked: false },
        { value: 'Xanh dương', label: 'Blue', checked: true },
        { value: 'Nâu', label: 'Brown', checked: false },
        { value: 'Xanh lá', label: 'Green', checked: false },
        { value: 'Đen', label: 'Black', checked: false },
      ],
    },
    {
      id: 'cost',
      name: 'Mức giá',
      options: [
        { value: '< 300.000đ', label: '1', checked: false },
        { value: '300.000đ - 500.000đ', label: '2', checked: false },
        { value: '500.000đ - 1.000.000đ', label: '3', checked: true },
        { value: '1.000.000đ - 1.5000.000đ', label: '4', checked: false },
        { value: '> 1.500.000đ', label: '5', checked: false },
      ],
    },
    {
      id: 'size',
              ...
              >
                <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl">
                  ...
                  <form className="mt-4 border-t border-gray-200">
                    <h3 className="sr-only">Mức giá</h3>
              ...
              <form className="hidden lg:block">
                ...
                <ul role="list" className="space-y-4 border-b border-gray-200 pb-6 text-sm font-medium text-gray-900">
                  {subCategories.map((category) => (
                    <li key={category.name}>
                      <a
                        className="no-underline font-semibold uppercase text-black hover:text-gray-400"
                        href={category.href}
                      >
                        {category.name}
                      </a>
